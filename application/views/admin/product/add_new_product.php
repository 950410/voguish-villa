...
<div class="view" style="margin:70px 220px;">
    <?php echo form_open('admin/category/add_product')?>
        <p><h3><strong></strong><span style="color: #383a1e">Enter the name:</strong></span></h3></p>
            <div class="input-group" style="display: inline-block">
                <input type="text" class="form-control" placeholder="Enter the product name here..."  name="product_name"  style= "width:600px; height:50px ">
                <input type="text" class="form-control" placeholder="Enter the product description here..."  name="product_des"  style= "width:600px; height:50px ">
                <input type="text" class="form-control" placeholder="Enter the product name here..."  name="product_name"  style= "width:600px; height:50px ">
                <input type="text" class="form-control" placeholder="Enter the product name here..."  name="product_name"  style= "width:600px; height:50px ">
                <input type="text" class="form-control" placeholder="Enter the product name here..."  name="product_name"  style= "width:600px; height:50px ">
