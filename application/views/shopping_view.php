                  ...
                  if ($cart = $this->cart->contents()): ?>
                    ...
                    <tr>
                        ...
                        <td colspan="5" align="right"><input type="button" class ='fg-button teal' value="Clear Cart" onclick="clear_cart()">
                            ...
                            <input type="button" class ='fg-button teal' value="Place order" onclick="window.location = 'billing_view'">
                            <input type="button" class ='fg-button teal' value="Continue Shopping" onclick="window.location = 'index'"></td>
